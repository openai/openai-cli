...
func setupCurrentImageFont(ctx context.Context, out io.Writer, dir, tty string, services imageFontServices) (err error) {
	...
	activated := false
	defer func() {
		if err != nil && !activated && services.restore != nil {
