...
func TestImagePreviewDetection(t *testing.T) {
	for _, test := range []struct {
		...
		{"WezTerm", true, map[string]string{"TERM_PROGRAM": "WezTerm"}, ITerm2},
		{"Warp", true, map[string]string{"TERM_PROGRAM": "WarpTerminal"}, ITerm2},
		{"Kitty program", true, map[string]string{"TERM_PROGRAM": "kitty"}, Kitty},
