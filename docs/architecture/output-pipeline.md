...
import generated commands or the executable. Transformers cannot depend on I/O
or presentation libraries. Feature implementation libraries cannot reach back
into the command tree or custom runtime. These dependency checks need neither
