...
| Integration tests | Local mock executable and OpenAPI snapshot | Checked-in spec is hash-checked by default; an explicit path/URL is caller-selected. | Locked npm packages installed in a temporary directory outside the checkout; mock binds `127.0.0.1:4010`. | Local test process only. | `npm ci --ignore-scripts`, lockfile integrity, private install, and native-binary resolution checks. | [scripts/mock:7-22](../../scripts/mock#L7-L22), [scripts/mock:26-83](../../scripts/mock#L26-L83), [scripts/mock-tools/resolve-native.js:4-48](../../scripts/mock-tools/resolve-native.js#L4-L48) |
