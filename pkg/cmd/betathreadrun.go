...
func handleBetaThreadsRunsCreate(ctx context.Context, cmd *cli.Command) error {
	...
	if streamFlagValue, _ := cmd.Value("stream").(*bool); streamFlagValue != nil && *streamFlagValue {
		...
		return ShowJSONIterator(stream, maxItems, ShowJSONOpts{
			Context:        ctx,
			Operation:      "(resource) beta.threads.runs > (method) create",
...
func handleBetaThreadsRunsRetrieve(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		Context:        ctx,
		Operation:      "(resource) beta.threads.runs > (method) retrieve",
		OutputKind:     outputResponse,
		ExplicitFormat: explicitFormat,
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
...
func handleBetaThreadsRunsUpdate(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		Context:        ctx,
		Operation:      "(resource) beta.threads.runs > (method) update",
		OutputKind:     outputResponse,
		ExplicitFormat: explicitFormat,
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
...
func handleBetaThreadsRunsList(ctx context.Context, cmd *cli.Command) error {
	...
	if format == "raw" {
		...
		return ShowJSON(obj, ShowJSONOpts{
			Context:        ctx,
			Operation:      "(resource) beta.threads.runs > (method) list",
			OutputKind:     outputResponse,
			ExplicitFormat: explicitFormat,
			Format:         format,
			RawOutput:      cmd.Root().Bool("raw-output"),
...
func handleBetaThreadsRunsCancel(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		Context:        ctx,
		Operation:      "(resource) beta.threads.runs > (method) cancel",
		OutputKind:     outputResponse,
		ExplicitFormat: explicitFormat,
		Format:         format,
		RawOutput:      cmd.Root().Bool("raw-output"),
...
func handleBetaThreadsRunsSubmitToolOutputs(ctx context.Context, cmd *cli.Command) error {
	...
	if streamFlagValue, _ := cmd.Value("stream").(*bool); streamFlagValue != nil && *streamFlagValue {
		...
		return ShowJSONIterator(stream, maxItems, ShowJSONOpts{
			Context:        ctx,
			Operation:      "(resource) beta.threads.runs > (method) submit_tool_outputs",
			OutputKind:     outputStreamEvent,
			ExplicitFormat: explicitFormat,
			Format:         format,
			RawOutput:      cmd.Root().Bool("raw-output"),
