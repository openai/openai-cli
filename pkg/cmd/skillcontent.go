...
var skillsContentRetrieve = cli.Command{
	Name:    "retrieve",
	...
	Action:          handleSkillsContentRetrieve,
	HideHelpCommand: true,
}

func handleSkillsContentRetrieve(ctx context.Context, cmd *cli.Command) error {
	...
	response, err := client.Skills.Content.Get(ctx, cmd.Value("skill-id").(string), options...)
	if err != nil {
		return err
	}
